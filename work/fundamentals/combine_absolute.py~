...
ratios_loc = '/home/mark/workspace/final-year-project/data/fundamentals/pe-ratios-absolute/'

save_loc = '/home/mark/workspace/final-year-project/data/fundamentals/pe_absolute_returns.csv'
...
with open(save_loc, "wb") as f:
    writer = csv.writer(f)
    writer.writerow(['symbol', 'pe-absolute-ratio', 'returns'])
